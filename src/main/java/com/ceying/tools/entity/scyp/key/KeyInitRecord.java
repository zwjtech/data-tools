package com.ceying.tools.entity.scyp.key;

import java.io.Serializable;
import java.util.Date;

public class KeyInitRecord implements Serializable {
    private String urid;
    ...
    private Integer keyinitversion;
    ...
    public Integer getKeyinitversion() {
        return keyinitversion;
    }

    public void setKeyinitversion(Integer keyinitversion) {
        this.keyinitversion = keyinitversion;
    }
    ...
    public String toString() {
        ...
        sb.append(", keyinitversion=").append(keyinitversion);
