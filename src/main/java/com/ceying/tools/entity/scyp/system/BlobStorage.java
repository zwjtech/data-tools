...
public class BlobStorage implements Serializable {
    private String lStorageid;
    ...
    public String getlStorageid() {
        return lStorageid;
    }

    public void setlStorageid(String lStorageid) {
        this.lStorageid = lStorageid == null ? null : lStorageid.trim();
    }
