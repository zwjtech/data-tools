...
@Table(name = "t_bankindividuation")
public class CypBankIndividuation implements Serializable {
    private String urid;
    ...
    public void setQuotetemplate(String quotetemplate) {
        this.quotetemplate = quotetemplate == null ? null : quotetemplate.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", quotetemplate=").append(quotetemplate);
