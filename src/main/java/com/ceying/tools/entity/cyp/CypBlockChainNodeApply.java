...
@Table(name = "T_BLOCKCHAINNODEAPPLY")
public class CypBlockChainNodeApply implements Serializable {
    private String urid;
    ...
    public byte[] getApplycontent() {
        return applycontent;
    }

    public void setApplycontent(byte[] applycontent) {
